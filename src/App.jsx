  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const targets = document.querySelectorAll(
        '.section-title, .about-content, .service-card, .certificate-card, .portfolio-item, .contact-content, .skill-item, .blog-card, section, main section'
      );
